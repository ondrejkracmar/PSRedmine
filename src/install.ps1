<#
	.SYNOPSIS
		Installs the PSRedmine Module from github
		
	.DESCRIPTION
		This script installs the PSRedmine Module from github.
...
$ModuleName = "PSRedmine"

# Base path to the github repository
$BaseUrl = "https://github.com/<InsertUsernameHere>/PSRedmine"
